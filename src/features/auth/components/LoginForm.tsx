  ...
  return (
    ...
    >
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-yellow-400">Login to your Account</h1>
        <p className="mt-2 text-sm text-gray-400">See what is going on with your business</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-gray-400">
        Not registered yet?{' '}
        <Link to="/register" className="font-semibold text-yellow-400 hover:underline">
          Create an account
        </Link>
      </p>
    </form>
