...
import { ShieldCheck, MapTrifold, TrafficSignal, BellRinging, ClockCountdown, UsersThree } from '@phosphor-icons/react';
...
export const FeatureCard: React.FC<FeatureCardProps> = ({ iconType, title, description }) => {
    const renderIcon = () => {
        ...
        switch (iconType) {
            ...
            case 'map': return <MapTrifold {...iconProps} />;
            case 'signal': return <TrafficSignal {...iconProps} />;
            case 'bell': return <BellRinging {...iconProps} />;
            case 'clock': return <ClockCountdown {...iconProps} />;
            case 'users': return <UsersThree {...iconProps} />;
            default: return null;
        }
    };
